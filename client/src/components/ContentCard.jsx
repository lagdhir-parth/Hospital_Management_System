...
const ContentCard = (props) => {
  return (
    <div
      className="group flex flex-col items-center p-10 px-8 bg-(--color-surface) rounded-2xl gap-4 mb-8 border border-(--color-border) hover:bg-(--color-primary-light) hover:shadow-lg hover:border-transparent transition-all duration-200 transform hover:-translate-y-2"
